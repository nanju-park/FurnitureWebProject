                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="product-details.html" class="d-block">
                                                        <div class="image-wrap">
                                                            <img src="<%=cp %>/resources/assets/img/products/prod-01-70x88.jpg" alt="Product">
                                                        </div>
                                                        <h4 class="product-name">Golden Easy Spot Chair.</h4>
                                                    </a>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="product-details.html" class="d-block">
                                                        <div class="image-wrap">
                                                            <img src="<%=cp %>/resources/assets/img/products/prod-02-70x88.jpg" alt="Product">
                                                        </div>
                                                        <h4 class="product-name">Golden Easy Spot Chair.</h4>
                                                    </a>
                                                    <a href="cart.html" class="btn btn-size-md">Add to cart</a>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="product-details.html" class="d-block">
                                                        <div class="image-wrap">
                                                            <img src="<%=cp %>/resources/assets/img/products/prod-03-70x88.jpg" alt="Product">
                                                        </div>
                                                        <h4 class="product-name">Golden Easy Spot Chair.</h4>
                                                    </a>
                                                    <a href="cart.html" class="btn btn-size-md">Add to cart</a>
                                            ...
                                            <tr>
                                                <th>Description</th>
                                                <td class="text-center">Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestasâ¦    </td>
                                                <td class="text-center">Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestasâ¦    </td>
                                                <td class="text-center">Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestasâ¦    </td>
                                            </tr>
                                            <tr>
