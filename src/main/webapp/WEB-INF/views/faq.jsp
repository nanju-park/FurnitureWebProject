    ...
    <div class="wrapper">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="product-details-slider-full-width.html">
                                                                        <span class="mm-text">Slider Box Full
                                                                            Width</span>
                                                                    </a>
                                                                </li>
                                                                <li>
        ...
        <div id="content" class="main-content-wrapper">
            <div class="page-content-inner">
                <div class="faq-area pt--75 pb--70">
                    <div class="container">
                        <div class="row mb--40">
                            <div class="col-12">
                                <h2>Frequently Asked Questions &amp; Answers</h2>
                                <p>Have a look at frequently asked questions &amp; answers to understand more.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 mb-md--50">
                                <div class="accordion accordion-2" id="accordionTwo">
                                    <div class="card">
                                        ...
                                        <div id="collapseFour" class="collapse show" aria-labelledby="headingFour" data-parent="#accordionTwo">
                                            <div class="card-body">
                                                ...
                                                <br>
                                                * Fee â Fee for the engagement. This could be a flat fee or an hourly fee.<br>
                                                * Fee arrangement â Management fee based upon your assets.<br>
                                                * Commission â if there were a particular product that fit your situation, we would be able to implement a product where the product company compensates us.<br>
                                                * Hybrid â Combination approach<br>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionTwo">
                                            <div class="card-body">
                                                Financial Planning can be done on an âas neededâ basis through various engagements that have a start and an end or on an ongoing basis through a financial planning retainer fee.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                            ...
                            <div class="col-lg-6">
                                <div class="accordion accordion-2" id="accordionThree">
                                    <div class="card">
                                        <div class="card-header" id="headingSeven">
                                            <a class="btn btn-link" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
                                                Is there a benefit to âdiversifying advisorsâ?
                                            </a>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordionThree">
                                            <div class="card-body">
                                                An independent financial professional is not an employee of an investment or financial services firm â they are an independent business owner. They have the freedom to structure their business in a manner that best serves their clients. The independent financial professional utilizes the services of the broker/dealer to process investment business, provide services such as practice management and education.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordionThree">
                                            <div class="card-body">
                                                Client: Now, more than ever, a client wants ââpeace of mindââ when it comes to the safety of financial assets. <br>
                ...
                <div class="question-area bg-color pt--75 pb--80" data-bg-color="#e9fefd">
                    <div class="container-fluid p-0">
                        <div class="row no-gutters">
                            <div class="col-12">
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-lg-8 col-10 text-center">
                                        <h3 class="mb--35">Do you have any question? Submit it now!</h3>
                                        <a href="contact-us.html" class="btn btn-bg-white btn-hover-2">Get In Touch Now <i class="la la-caret-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="mini-cart__list">
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-content">
                                    <a class="mini-cart__product-title" href="product-details.html">Golden Easy Spot
                                        Chair.</a>
                            ...
                            "nextArrow": {"buttonClass": "slick-btn slick-next", "iconClass": "la la-angle-double-right" }
                                    ...
                                    <div class="product-image">
                                        <div class="product-image--holder">
                                            <a href="product-details.html">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-01.jpg" alt="Product Image"
                                                    class="primary-image">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-image">
                                        <div class="product-image--holder">
                                            <a href="product-details.html">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-02.jpg" alt="Product Image"
                                                    class="primary-image">
                                            </a>
                                        </div>
                                        <span class="product-badge sale">sale</span>
