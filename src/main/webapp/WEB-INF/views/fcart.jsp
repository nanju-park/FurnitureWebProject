...
<script type="text/javascript">
	...
	function init () {
		...
		document.form.orderSum.value = paysell_price;
		document.basket.orderSum.value = basketsell_price;
	...
	function add () {
		...
		sumpay = document.form.orderSum;
		hmbasket = document.basket.amount;
		sumbasket = document.basket.orderSum;
                    ...
                    <div class="row">
												 ...
												 <c:forEach var="dto" items="${orderlists}">
                                                    <tr>
                                                        ...
                                                        <td class="product-thumbnail text-left">
                                                            <img src="<%=cp %>/resources/assets/img/product/pro1.jpg" height="88" width="70" alt="Product Thumnail">
                                                        </td>
                                                        <td class="product-name text-left wide-column">
                                                            <h3>
                                                                <a href="product-details.html">${dto.subject}</a>
                                                            </h3>
                                                        </td>
                                                        <td class="product-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money">${dto.price}</span>
                                                            </span>
                                                        </td>
                                                        <td class="product-quantity">
                                                            <div class="quantity">
                                                            <strong>${dto.amount}</strong>
                                                        ...
                                                        <td class="product-total-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money">
                                                                   <fmt:formatNumber value="${dto.orderSum }" pattern="###,###,###"/>원
                                                                </span>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="product-remove text-left"><a href=""><i class="la la-remove"></i></a></td>
                                                        <td class="product-thumbnail text-left">
                                                            <img src="<%=cp %>/resources/assets/img/product/pro2.jpg" height="88" width="70" alt="Product Thumnail">
                                                        </td>
                                                        <td class="product-name text-left wide-column">
                                                            <h3>
                                                                <a href="product-details.html">[예제] Louis poulsen </a>
                                                            </h3>
                                                        </td>
                                                        <td class="product-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money">1,970,000원 </span>
                                                            </span>
                                                        </td>
                                                        <td class="product-quantity">
                                                            <div class="quantity">
                                                    ...
                                                    <tr>
                                                        <td class="product-remove text-left"><a href=""><i class="la la-remove"></i></a></td>
                                                        <td class="product-thumbnail text-left">
                                                            <img src="<%=cp %>/resources/assets/img/product/pro3.jpg" height="88" width="70" alt="Product Thumnail">
                                                        </td>
                                                        <td class="product-name text-left wide-column">
                                                            <h3>
                                                                <a href="product-details.html">[예제] 라인 체어 </a>
                                                            </h3>
                                                        </td>
                                                        <td class="product-price">
                                                            <span class="product-price-wrapper">
                                                        ...
                                                        <td class="product-total-price">
                                                            <span class="product-price-wrapper">
                                                                <span class="money">
                                                                <b><input type="text" name="orderSum" size="4" readonly style="border:none;">원</b>
                                                                </span>
                                                            </span>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="col-lg-4">
                            <div class="cart-collaterals">
                                ...
                                <a href="payment.fu" class="btn btn-size-md btn-shape-square btn-fullwidth">
                                    상품주문
                                </a>
                            </div>
                        </div>
