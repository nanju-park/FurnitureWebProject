              			...
              			<div class="login-box">
              				<h3 class="heading__terriary mb--30" style="text-align: center">회원가입</h3>
								...
								<input type="text" class="form__input" id="phone2" name="phone2" maxlength="8" placeholder="'-'를 제외하고 입력하세요">
                                  ...
                                  <div class="form__group mb--20">
                           			<input type="text" id="sample4_postcode" placeholder="우편번호"  name="addr1" class="form__input" style="width: 150px">
		                          ...
		                          <div class="form__group mb--20">
									<input type="text" id="sample4_roadAddress" name="addr2"  placeholder="도로명주소" class="form__input" style="width: 220px;">
									<input type="text" id="sample4_extraAddress"  placeholder="참고주소" class="form__input" style="width: 136px;">
									<input type="hidden" id="sample4_jibunAddress" placeholder="지번주소">
									<span id="guide" style="color:#999;display:none"></span>
								  </div>
								  <div class="form__group mb--20"> 
									<input type="text" id="sample4_detailAddress"  name="addr3"  placeholder="상세주소" class="form__input" style="height: 50px"><br/>
                                  </div>
                                  
                                  <div class="form__group mb--20">            
                                      <input type="button" class="form__input" value="회원가입" style="background-color: #FF5151; font-size:13pt; color:#ffffff;" onclick="check('<%=cp%>');">    
                                      <a href="home.fu">
