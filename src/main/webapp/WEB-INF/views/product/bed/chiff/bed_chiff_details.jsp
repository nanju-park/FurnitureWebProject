                        ...
                        <div class="col-xl-4 offset-xl-1 col-lg-5 product-main-details mt-md--50">
                            <div class="product-summary pl-lg--30 pl-md--0">
                                ...
                                <form action="#" class="variation-form mb--20">
                                	<c:if test="${dto.imageIndex == 131 || dto.imageIndex == 135 || dto.imageIndex == 136 }">
                               		...
                               		<!-- 133 -->
                               		<c:if test="${dto.imageIndex == 133 }">
                               			<div class="product-size-variations d-flex align-items-center mb--15">
	                                        <p class="variation-label">Option:</p>   
	                                        <div class="product-size-variation variation-wrapper">
	                                        	<select id="optionV">
	                                            	<option selected="selected" value="default">- [리놀륨] 옵션을 선택해주세요 -</option>
	                                            	<option disabled="disabled">-----------------------------------</option>
                               			...
                               			<div class="product-size-variations d-flex align-items-center mb--15">
	                                        ...
	                                        <div class="product-size-variation variation-wrapper">
	                                        	<select id="optionV">
	                                            	...
	                                            	<option disabled="disabled">-----------------------------------</option>
	                                            	<option value="302 오크 4단8칸 서랍장">302 오크 4단8칸 서랍장</option>
	                                            </select>
	                                        </div>                                 
	                                    </div>
                               		</c:if>
                                ...
                                <div class="tab-content" id="product-tabContent">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                           <c:choose>
                                           		<c:when test="${dto.imageIndex == 132 }">
