                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>협탁</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-7">
                                        <div class="shop-toolbar__right d-flex justify-content-md-end justify-content-start flex-sm-row flex-column">
                                            ...
                                            <p class="product-pages">홈 > 침실/베드룸 > 협탁</p>
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-category">
                                                        <a href="bed_${dto.cateEn }_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateEn }">${dto.cate }</a>
                                                    </div>
                                                    <h3 class="product-title"><a href="bed_${dto.cateEn }_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateEn }">${dto.productName }</a></h3>
