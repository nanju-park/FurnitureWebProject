...
<%
FurnitureDTO dto2=(FurnitureDTO)request.getAttribute("dto");
if(dto2.getProductName().contains("[")){       
	 dto2.setProductName(dto2.getProductName().replace("[", "%5B"));
	 dto2.setProductName(dto2.getProductName().replace("]", "%5D"));
} 
dto2.setPrice(dto2.getPrice().replaceAll(",",""));
...
<%-- 	function buynowevent(eventdata){
	...
	<%-- function paysubmit(){
		location.href="<%=cp%>/payment.fu?data="+d;
	} --%>
                            ...
                            <div class="product-summary pl-lg--30 pl-md--0">
                                ...
                                <form action="#" class="variation-form mb--20">
                                    <div class="product-size-variations d-flex align-items-center mb--15">
                                        ...
                                        <div class="product-size-variation variation-wrapper">
                                            ...
                                            <c:if test="${dto.imageIndex==412}">
                                            <select>
                                            	<option selected="selected">- [해당없음] -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==413 }">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [색상] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            	<option value="white/rose">white/rose</option>
                                            	<option value="rose/green">rose/green</option>
                                            	<option value="armygreen/dg">armygreen/dg</option>
                                            	<option value="dg/turquoise">dg/turquoise</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==414 }">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [색상] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            ...
                                            <c:if test="${dto.imageIndex==416}">
                                            <select >
                                            	<option selected="selected">- [해당없음] -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==417 }">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [색상] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            	<option value="white">white</option>
                                            ...
                                            <c:if test="${dto.imageIndex==419}">
                                            <select >
                                            	<option selected="selected">- [해당없음] -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==420 }">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [사이즈] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            	<option value="college450">college450</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==421}">
                                            <select>
                                            	<option selected="selected">- [해당없음] -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            </select>
                                ...
                                <div class="product-action d-flex flex-sm-row align-items-sm-center flex-column align-items-start mb--30">
                                    <!-- <div class="quantity-wrapper d-flex align-items-center mr--30 mr-xs--0 mb-xs--30">
                                     ...
                                     %>
                                    <button type="button" id="cart" class="btn btn-size-sm btn-shape-square" onclick="clickevent('${dto.cateEn}:<%=dto1.getProductName() %>:<%=dto1.getPrice()%>:/resources/images/deco/${dto.saveFileName}');">
                                        Add To Cart
                                    </button>
                                </div>  
                                ...
                                <!-- 상품상세정보 -->
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_3.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_4.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_5.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_6.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_7.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_8.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_9.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_10.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_11.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_12.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/light/${dto.imageIndex}_details_13.jpg"><br/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-content table-responsive">
                                            <table class="table shop_attributes">
                                                <tbody>
                                                    <tr>
                                                     <td>
                                                     	<img alt="" src="<%=cp %>/resources/images/deco/detail/light/411_buydetails.jpg"><br/>
                                                     	<img alt="" src="<%=cp %>/resources/images/deco/detail/light/411_buydetails_2.jpg">
                                                     </td>
                                                    </tr>
                                                </tbody>
                                            </table>
    	...
    	<div class="modal fade product-modal" id="payModal" tabindex="-1" role="dialog" aria-hidden="true">
        	<div class="modal-dialog" role="document" style="width: 300">
        		<div class="modal-content">
        			<div class="modal-body" align="center"><br><br><br>
    					결제하시겠습니까?<br>
