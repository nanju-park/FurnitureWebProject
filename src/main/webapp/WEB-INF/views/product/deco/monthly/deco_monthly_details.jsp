                                ...
                                <!-- 상품상세정보 -->
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                            ...
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/monthly/${dto.imageIndex}_details_9.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/monthly/${dto.imageIndex}_details_10.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/monthly/${dto.imageIndex}_details_11.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/monthly/${dto.imageIndex}_details_12.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/deco/detail/monthly/${dto.imageIndex}_details_13.jpg"><br/> --%>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ft-product">
                                        <div class="product-inner">
                                            <div class="product-image">
                                                ...
                                                <a href="deco_monthly_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}" class="product-overlay"></a>
                                            ...
                                            <div class="product-info">
                                                <div class="product-category">
                                                    <a href="deco_monthly_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.cate }</a>
                                                </div>
                                                <h3 class="product-title"><a href="deco_monthly_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.productName }</a></h3>
