                                ...
                                <form action="#" class="variation-form mb--20">
                                    <div class="product-size-variations d-flex align-items-center mb--15">
                                        ...
                                        <div class="product-size-variation variation-wrapper">
                                        	<c:if test="${dto.imageIndex==61}">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [리놀륨색상] 옵션을 선택해주세요 -</option>
                                            ...
                                            <br/>
                                            <select>
                                            	<option selected="selected">- [철제색상] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==62}">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [프레임] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                            	<option value="철제 프레임 BLACK">철제 프레임 BLACK</option>
                                            </select>
                                            </c:if>
                                            <c:if test="${dto.imageIndex==63}">
                                        	<select id="optionV">
                                            	<option selected="selected" value="default">- [수종] 옵션을 선택해주세요 -</option>
                                            	<option disabled="disabled">-----------------------------------</option>
                                ...
                                <!-- 상품상세정보 -->
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_3.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_4.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_5.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_6.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_7.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_8.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_9.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_10.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_11.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_12.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_13.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_14.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_15.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_16.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_17.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_18.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_19.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_20.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_21.jpg"><br/>
                                            <img alt="" src="<%=cp %>/resources/images/dining/detail/deco/${dto.imageIndex}_details_22.jpg"><br/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-content table-responsive">
                                            <table class="table shop_attributes">
                                                <tbody>
                                                    <tr>
                                                     <td>
                                                     	<img alt="" src="<%=cp %>/resources/images/dining/detail/deco/61_buydetails.jpg"><br/>
                                                     	<img alt="" src="<%=cp %>/resources/images/dining/detail/deco/61_buydetails_2.jpg">
                                                     </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="ft-product">
                                        <div class="product-inner">
                                            <div class="product-image">
                                                ...
                                                <a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}" class="product-overlay"></a>
                                            ...
                                            <div class="product-info">
                                                <div class="product-category">
                                                    <a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.cate }</a>
                                                </div>
                                                <h3 class="product-title"><a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.productName }</a></h3>
