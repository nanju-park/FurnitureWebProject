                                            ...
                                            data-slick-options='{
                                                ...
                                                <figure class="product-gallery__image zoom">
                                                    ...
                                                    <div class="product-gallery__actions">
                                                       ...
                                                       <!--  <a href="https://youtu.be/czyP_vZyhHw" class="action-btn video-popup"><i class="la la-play"></i></a> -->
                                                    </div>
                                                </figure>
                                                <figure class="product-gallery__image zoom">
                                                    <img src="<%=cp %>/resources/images/dining/${dto.saveFileName}" alt="Product">
                                ...
                                <!-- 상품상세정보 -->
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                            <img alt="product" src="<%=cp %>/resources/images/dining/detail/sunbrella/${dto.imageIndex}_details_5.jpg"><br/>
                                            <img alt="product" src="<%=cp %>/resources/images/dining/detail/sunbrella/${dto.imageIndex}_details_6.jpg"><br/>
                                            <img alt="product" src="<%=cp %>/resources/images/dining/detail/sunbrella/${dto.imageIndex}_details_7.jpg"><br/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-content table-responsive">
                                            <table class="table shop_attributes">
                                                <tbody>
                                                    <tr>
                                                     <td>
                                                     	<img alt="" src="<%=cp %>/resources/images/dining/detail/sunbrella/1_buydetails.jpg"><br/>
                                                     	<img alt="" src="<%=cp %>/resources/images/dining/detail/sunbrella/1_buydetails_2.jpg">
                                                     </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="ft-product">
                                        <div class="product-inner">
                                            <div class="product-image">
                                                ...
                                                <a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}" class="product-overlay"></a>
                                            ...
                                            <div class="product-info">
                                                <div class="product-category">
                                                    <a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.cate }</a>
                                                </div>
                                                <h3 class="product-title"><a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex}&cateEn=${dto.cateEn}">${dto.productName }</a></h3>
