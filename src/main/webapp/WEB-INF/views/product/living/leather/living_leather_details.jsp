                        ...
                        <div class="col-xl-4 offset-xl-1 col-lg-5 product-main-details mt-md--50">
                            <div class="product-summary pl-lg--30 pl-md--0">
                                ...
                                <form action="#" class="variation-form mb--20">
                                	<!-- 가죽 소파 -->
                                	<c:choose>
                                		<c:when test="${dto.imageIndex == 231 }">
                                		...
                                		<c:when test="${dto.imageIndex == 237 || dto.imageIndex ==238 }">
	                                    	<div class="product-size-variations d-flex align-items-center mb--15">
		                                        ...
		                                        <div class="product-size-variation variation-wrapper">
		                                        	<select id="optionV">
		                                            	...
		                                            	<option disabled="disabled">-----------------------------------</option>
		                                            	<option value="돌핀그레이-오크">돌핀그레이-오크</option>
		                                            	<option value="스톤그레이-오크">스톤그레이-오크</option>
		                                            	<option value="카라멜-오크">카라멜-오크</option>
		                                            	<option value="모가노-오크">모가노-오크</option>
		                                            </select>
		                                        </div>                                 
		                                    </div>
                                		</c:when>
                                			...
                                			<div class="product-size-variations d-flex align-items-center mb--15">
		                                        ...
		                                        <div class="product-size-variation variation-wrapper">
		                                        	<select id="optionV">
		                                            	<option selected="selected" value="default">- [필수] 옵션을 선택해주세요 -</option>
		                                            	<option disabled="disabled">-----------------------------------</option>
		                                            	<option value="돌핀그레이">돌핀그레이</option>
		                                            	<option value="스톤그레이">스톤그레이</option>
		                                            	<option value="카라멜">카라멜</option>
		                                            	<option value="모가노">모가노</option>
		                                            </select>
		                                        </div>                                 
		                                    </div>
                                		</c:otherwise>
                            ...
                            <div class="tab-style-2">
                                ...
                                <div class="tab-content" id="product-tabContent">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        ...
                                        <c:choose>
                                        	<c:when test="${dto.imageIndex == 231 }">
                                        		<embed style="width: 900px; height: 550px;" src="https://www.youtube.com/embed/SIAbYSDkYvw"> 
                                        	...
                                        	<c:when test="${dto.imageIndex == 232 }">
                                        		<img alt="" src="<%=cp%>/resources/images/livingroom/${dto.imageIndex}_detail1.jpg">	
	                                            <img alt="" src="<%=cp%>/resources/images/livingroom/${dto.imageIndex}_detail2.jpg">	
	                                            <img alt="" src="<%=cp%>/resources/images/livingroom/${dto.imageIndex}_detail3.jpg">	
	                                            <img alt="" src="<%=cp%>/resources/images/livingroom/${dto.imageIndex}_detail4.jpg">	
                                        	...
                                        	<c:when test="${dto.imageIndex == 235 }">
